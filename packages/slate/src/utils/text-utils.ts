...
const SURROGATE_START: number = 0xd800;
const SURROGATE_END: number = 0xdfff;
...
function isWord(char: string, remaining?: string): boolean {
    ...
    if (CHAMELEON.test(char) && remaining) {
