...
import { IS_IOS } from "@zykj/slate-dev-environment";
import getWindow from "get-window";
import { Text } from "@zykj/slate";
...
function AfterPlugin() {
  let isDraggingInternally: any = null;
  ...
  function onClick(event, change, editor): any {
